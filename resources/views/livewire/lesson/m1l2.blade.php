<div class="p-4  sm:mx-6 sm:pt-0" id="m1l2">
    @if ($latest_slide_order >= 1)
        @livewire('lesson.slides.m1l2s1', ['latest_slide_order' => $latest_slide_order])
    @endif
    ...
    @if ($latest_slide_order >= 5)
        @livewire('lesson.slides.m1l2s5', ['latest_slide_order' => $latest_slide_order])
    @endif
    ...
    @if ($latest_slide_order >= 9)
        @livewire('lesson.slides.m1l2s9', ['latest_slide_order' => $latest_slide_order])
    @endif
    @if ($latest_slide_order >= 10)
        @livewire('lesson.slides.m1l2s10', ['latest_slide_order' => $latest_slide_order])
    @endif
</div>
