<div id="m3l1s2" class="pt-36 {{ $current_slide ? 'min-h-screen' : '' }}">
    <div class="border-b-2 border-secondary w-fit">
        <h1 class="font-intelbold text-intelblue text-3xl pb-2">AI for Health</h1>
    </div>
    <div class="text-gray-700 my-14">
        <div>
            <p class="text-justify text-lg leading-tight">
                AI for Health empowers researchers and organizations with AI to improve the health of people and
        ...
        <div class="xl:flex my-3 justify-around items-center">
            ...
            <div class="w-full lg:max-w-sm lg:mx-auto xl:max-w-none xl:mx-auto">
                <div class="video-container mx-auto">
                    <iframe src="https://www.youtube.com/embed/6jNL601th0Y" title="YouTube video player" frameborder="0"
        ...
        <div class="my-14">
            <ul class="pl-5 grid grid-cols-2 gap-3">
                <li class="mb-4">
