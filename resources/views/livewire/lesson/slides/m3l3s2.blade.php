<div id="m3l3s2" class="pt-36 {{ $current_slide ? 'min-h-screen' : '' }}">
    <h3 class="font-intelmedium text-gray-500 text-lg pb-4">AI Ethics Canvas</h3>
    <div class="border-b-2 border-secondary w-fit">
        <h1 class="font-intelbold text-intelblue text-3xl pb-2">Bias</h1>
    </div>
    <div class="text-gray-700 my-14">
        <div>
            <p class="text-justify text-lg leading-tight">
                Developing AI systems that are fair and unbiased is a challenge. A few points to consider:
            </p>
        </div>
        <div class="xl:flex my-3 justify-around items-center">
                ...
                <ul class="pl-5">
                    <li class="mb-4">
                        <span class="inline-flex">
                            ...
                            Is your Dataset equally representative of the population? 
                        </span>
                    </li>
                    <li class="mb-4">
                        <span class="inline-flex">
            ...
            <div class="w-full lg:max-w-md lg:mx-auto xl:mx-auto">
                <div class="w-full lg:max-w-md lg:mx-auto xl:mx-auto">
                    <img src="{{ asset('images/course/bias.png') }}" alt="ai" class="mx-auto lg:max-w-sm lg:p-6 object-scale-down">
                </div>
            </div>
        </div>
    </div>
