<div id="m3l2s2" class="pt-36 {{ $current_slide ? 'min-h-screen' : '' }}">
    <div class="border-b-2 border-secondary w-fit">
        <h1 class="font-intelbold text-intelblue text-3xl pb-2">What do you mean by AI Ethics?</h1>
    </div>
                ...
                <ul class="pl-5">
                    <li class="mb-4">
                        <span class="inline-flex">
                            ...
                            AI Ethics is a system of moral principles intended to inform the responsible development and
                            use of AI.
                        </span>
                    </li>
                    <li class="mb-4">
                        <span class="inline-flex">
                            ...
                            There are multiple advantages of AI, but these technologies can also have a downside to it,
                    ...
                    <li class="mb-4">
                        <span class="inline-flex">
                            ...
                            Therefore, we need policies and regulatory frameworks to ensure ethics in AI which will
