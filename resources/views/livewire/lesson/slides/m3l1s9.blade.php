<div id="m3l1s9" class="pt-36 {{ $current_slide ? 'min-h-screen' : '' }}">
    <div class="border-b-2 border-secondary w-fit">
        <h1 class="font-intelbold text-intelblue text-3xl pb-2">AI at Work</h1>
    </div>
    <div class="text-gray-700 my-14">
        <div>
            <p class="text-justify text-lg leading-tight">
                AI at Work involves the use of Artificial Intelligence to enhance productivity, efficiency, and
                decision-making in the workplace. AI can assist in automating repetitive tasks, analyzing large data
                sets, and improving customer experience.
            </p>
        </div>
        <div class="xl:flex my-3 justify-around items-center">
                ...
                <ul class="pl-5">
                    ...
                    <li class="mb-4">
                        <span class="inline-flex">
                            ...
                            AI for visual quality inspections
                        </span>
                    </li>
                </ul>
            </div>
            ...
            <div class="w-full lg:max-w-md lg:mx-auto xl:mx-auto">
                <div class="video-container">
                    <iframe src="https://www.youtube.com/embed/UY6xbrcViVw" title="YouTube video player" frameborder="0"
