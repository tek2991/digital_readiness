<div id="m1l2s8" class="mt-36 {{ $current_slide ? 'min-h-screen' : '' }}">
    ...
    <div class="text-gray-700 mt-8">
        <section class="grid grid-cols-1 md:grid-cols-3 my-12 gap-y-8 md:gap-x-8">
            <div class="max-w-sm mx-auto bg-white h-full flex flex-col">
                <div>
                    <img class="max-h-24 md:max-h-32 mx-auto" src="{{ asset('images/course/books.png') }}"
                        alt="" />
                    <div class="relative">
                ...
                <div class="p-5 h-full flex flex-col justify-center bg-yellow-300 mt-4 rounded-xl">
            ...
            <div class="max-w-sm mx-auto bg-white h-full flex flex-col">
                <div>
                    <img class="max-h-24 md:max-h-32 mx-auto" src="{{ asset('images/course/social.png') }}"
                        alt="" />
                    <div class="relative">
                ...
                <div class="p-5 h-full flex flex-col justify-center mt-4 rounded-xl" style="background-color: #ff758e;">
                    <p class="mb-3 text-white text-lg font-intelmedium text-center">Personalized social media content</p>
                </div>
            </div>
            <div class="max-w-sm mx-auto bg-white h-full flex flex-col">
                <div>
                    <img class="max-h-24 md:max-h-32 mx-auto" src="{{ asset('images/course/search.png') }}"
                        alt="" />
                    <div class="relative">
                ...
                <div class="p-5 h-full flex flex-col justify-center mt-4 rounded-xl" style="background-color: #7785f2;">
