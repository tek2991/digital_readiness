    ...
    <div class="text-gray-700 my-14">
        <div>
            <p class="text-justify text-lg leading-tight">
                When developing an AI system, it is crucial to consider the implications for human rights and ensure
                that ethical principles are upheld throughout the process.
            </p>
        </div>
        <div class="xl:flex my-3 justify-around items-center">
            ...
            <div class="w-full lg:max-w-md lg:mx-auto xl:mx-auto">
                <div class="w-full lg:max-w-md lg:mx-auto xl:mx-auto">
                    <img src="{{ asset('images/course/human_rights.png') }}" alt="ai"
