<div id="m3l3s1" class="pt-36 {{ $current_slide ? 'min-h-screen' : '' }}">
    <h3 class="font-intelmedium text-gray-500 text-lg pb-4">AI Ethics Canvas</h3>
    <div class="border-b-2 border-secondary w-fit">
        <h1 class="font-intelbold text-intelblue text-3xl pb-2">Human Rights</h1>
    </div>
    <div class="text-gray-700 my-14">
        <div>
            <p class="text-justify text-lg leading-tight">
                When developing an AI system, it is crucial to consider the implications for human rights and ensure that ethical principles are upheld throughout the process.
            </p>
        </div>
        <div class="xl:flex my-3 justify-around items-center">
                ...
                <ul class="pl-5">
                    ...
                    <li class="mb-4">
                        <span class="inline-flex">
                            ...
                            Use UN’s Declaration of Human Rights
                        </span>
                    </li>
                </ul>
            </div>
            ...
            <div class="w-full lg:max-w-md lg:mx-auto xl:mx-auto">
                <div class="w-full lg:max-w-md lg:mx-auto xl:mx-auto">
                    <img src="{{ asset('images/course/human_rights.png') }}" alt="ai" class="mx-auto lg:max-w-sm lg:p-6 object-scale-down">
                </div>
            </div>
        </div>
    </div>
