<div id="m3l1s5" class="pt-36 {{ $current_slide ? 'min-h-screen' : '' }}">
    <div class="border-b-2 border-secondary w-fit">
        <h1 class="font-intelbold text-intelblue text-3xl pb-2">Monitoring Marine Life</h1>
    </div>
    <div class="text-gray-700 my-14">
        <div class="xl:flex my-3 justify-around items-center">
                ...
                <ul class="pl-5">
                    <li class="mb-4 animate-left-slow">
                        <span class="inline-flex">
                            ...
                            One of the ways AI is helping to conserve oceans is by fighting plastic pollution with
                            machine learning.
                        </span>
                    </li>
                    <li class="mb-4">
                        <span class="inline-flex animate-left-slow-2">
                            ...
                            Underwater autonomous robots can reach unforeseen depths that are unlocking the wonders of
            ...
            <div class="w-full lg:max-w-md lg:mx-auto xl:mx-auto">
                <img src="{{ asset('images/course/marine.png') }}" alt="ai"
