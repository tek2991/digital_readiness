<div id="m3l3s5" class="pt-36 {{ $current_slide ? 'min-h-screen' : '' }}">
    <h3 class="font-intelmedium text-gray-500 text-lg pb-4">AI Ethics Canvas</h3>
    <div class="border-b-2 border-secondary w-fit">
        <h1 class="font-intelbold text-intelblue text-3xl pb-2">Explainable use of AI</h1>
    </div>
    <div class="text-gray-700 my-14">
        ...
        <div class="xl:flex my-3 justify-around items-center">
                ...
                <ul class="pl-5">
                    <li class="mb-4">
                        <span class="inline-flex">
                            ...
                            Can your implementation be easily described?
                        </span>
                    </li>
                    <li class="mb-4">
                        <span class="inline-flex">
                            ...
                            Could you explain the entire process of your AI project cycle?
                        </span>
                    </li>
                    <li class="mb-4">
                        <span class="inline-flex">
                    ...
                    <li class="mb-4">
                        <span class="inline-flex">
                            ...
                            Can you justify AI enabled decision?
                        </span>
                    </li>
                </ul>
            </div>
            ...
            <div class="w-full lg:max-w-md lg:mx-auto xl:mx-auto">
                <div class="w-full lg:max-w-md lg:mx-auto xl:mx-auto">
                    <img src="{{ asset('images/course/explainable.png') }}" alt="ai"
