<div id="m2l4s1" class="pt-36 {{ $current_slide ? 'min-h-screen' : '' }}">
    ...
    <div class="text-gray-700 mt-14" wire:ignore>
        <div id="badge-2" class="w-80 h-80 flex justify-between items-center mx-auto relative cursor-pointer"
    ...
    <script>
        function convertToImage() {
            ...
            const element = document.getElementById("badge-2");
        ...
        document.getElementById("badge-2").addEventListener("click", convertToImage);
    </script>
</div>
