<div id="m3l1s3" class="pt-36 {{ $current_slide ? 'min-h-screen' : '' }}">
    <div class="border-b-2 border-secondary w-fit">
        <h1 class="font-intelbold text-intelblue text-3xl pb-2">Cancer Screening</h1>
    </div>
                ...
                <ul class="pl-5">
                    ...
                    <li class="mb-4">
                        <span class="inline-flex">
                            ...
                            AI can help doctors make correct treatment decisions
                        </span>
                    </li>
                </ul>
            </div>
