    ...
    <div class="text-gray-700 mt-8">
        <div class="grid grid-cols-3 gap-3">
            <div class="relative animate-top-fast">
                <img src="{{ asset('images/course/industry.jpg') }}" alt=""
            ...
            <div class="relative animate-top">
                <img src="{{ asset('images/course/media.jpg') }}" alt=""
                    class="w-full h-full max-h-72 object-cover">
                <div
                    class="absolute bottom-0 w-full h-1/2 bg-gradient-to-b from-transparent to-slate-400 flex items-end justify-center">
            ...
            <div class="relative animate-top-slow">
                <img src="{{ asset('images/course/retail.jpg') }}" alt=""
                    class="w-full h-full max-h-72 object-cover">
                <div
                    class="absolute bottom-0 w-full h-1/2 bg-gradient-to-b from-transparent to-slate-400 flex items-end justify-center">
            ...
            <div class="relative animate-top-fast">
                <img src="{{ asset('images/course/smart_home.jpg') }}" alt=""
                    class="w-full h-full max-h-72 object-cover">
                <div
                    class="absolute bottom-0 w-full h-1/2 bg-gradient-to-b from-transparent to-slate-400 flex items-end justify-center">
            ...
            <div class="relative animate-top">
                <img src="{{ asset('images/course/telecom.jpg') }}" alt=""
                    class="w-full h-full max-h-72 object-cover">
                <div
                    class="absolute bottom-0 w-full h-1/2 bg-gradient-to-b from-transparent to-slate-400 flex items-end justify-center">
            ...
            <div class="relative animate-top-slow">
                <img src="{{ asset('images/course/transport.jpg') }}" alt=""
                    class="w-full h-full max-h-72 object-cover">
                <div
                    class="absolute bottom-0 w-full h-1/2 bg-gradient-to-b from-transparent to-slate-400 flex items-end justify-center">
