    ...
    <div class="text-gray-700 mt-8 min-h-screen">
        <div>
            <p class="text-justify text-lg leading-tight">
                ...
                that work
                with AI. The course is broken down into three modules.
            </p>
        </div>
        <div class="xl:flex my-3 justify-around items-center">
            <div>
                <p class="text-justify text-lg mb-4">By the end of this course, learners will be able to:</p>
                <ul class="pl-5">
                    <li class="mb-4">
                    ...
                    <li class="mb-4">
                        <span class="inline-flex">
                            ...
                            Identify present and future impacts of AI
                        </span>
                    </li>
                    <li class="mb-4">
                        <span class="inline-flex">
                    ...
                    <li class="mb-4">
                        <span class="inline-flex">
                            ...
                            Understand the process of building AI solutions
                        </span>
                    </li>
                </ul>
            </div>
