<div id="m1l2s9" class="pt-36 {{ $current_slide ? 'min-h-screen' : '' }}">
        ...
        <div class="">
            <ul class="pl-5">
                <li class="mb-4">
                    <span class="inline-flex">
                        ...
                        Automation is a way to make <span class="text-red-700"> &nbsp; machines work on their own</span>
                    </span>
                </li>
                <li class="mb-4">
                    <span class="inline-flex">
                        ...
                        Automatic machines need little or no human help
                    </span>
                </li>
                <li class="mb-4">
                    <span class="inline-flex">
                        ...
                        Automation <span class="text-red-700"> &nbsp; makes physical work easy</span>
                    </span>
                </li>
            </ul>
            ...
            <div class="grid grid-cols-3 gap-3">
                ...
                <div class="relative animate-right-slow">
                    ...
                    <div
                        class="absolute bottom-0 w-full h-1/2 bg-gradient-to-b from-transparent to-slate-400 flex items-end justify-center">
                        <p class="text-white font-intelmedium text-lg pb-2">Escalators</p>
                    </div>
                </div>
            </div>
        </div>
