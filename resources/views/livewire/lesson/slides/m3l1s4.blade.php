<div id="m3l1s4" class="pt-36 {{ $current_slide ? 'min-h-screen' : '' }}">
    <div class="border-b-2 border-secondary w-fit">
        <h1 class="font-intelbold text-intelblue text-3xl pb-2">AI for Social Good </h1>
    </div>
    <div class="text-gray-700 my-14">
        <div class="xl:flex my-3 justify-around items-center">
            ...
            <div class="w-full lg:max-w-md lg:mx-auto xl:mx-auto">
                <img src="{{ asset('images/course/social_good.png') }}" alt="ai"
                    class="mx-auto lg:max-w-md animate-opacity-slow">
            </div>
        </div>
    </div>
    <div class="mt-14">
