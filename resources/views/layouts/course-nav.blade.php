<nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 fixed w-full">
    <div class="container flex flex-wrap items-center justify-between mx-auto">
        ...
        <div class="w-auto block" id="navbar-default">
            <ul class="flex items-center p-1 md:p-4 pr-0 rounded-lg flex-row space-x-8 mt-0 text-base">
                @auth
    ...
    <div class="container flex flex-wrap items-center justify-between mx-auto border-t mt-2">
        <button data-drawer-target="sidebar-multi-level-sidebar" data-drawer-toggle="sidebar-multi-level-sidebar"
            ...
            class="inline-flex items-center p-2 mt-2 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200">
